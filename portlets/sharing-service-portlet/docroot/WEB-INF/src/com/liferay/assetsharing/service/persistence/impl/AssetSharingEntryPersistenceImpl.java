...
package com.liferay.assetsharing.service.persistence.impl;

import aQute.bnd.annotation.ProviderType;

import com.liferay.assetsharing.NoSuchAssetSharingEntryException;
import com.liferay.assetsharing.model.AssetSharingEntry;
import com.liferay.assetsharing.model.impl.AssetSharingEntryImpl;
import com.liferay.assetsharing.model.impl.AssetSharingEntryModelImpl;
import com.liferay.assetsharing.service.persistence.AssetSharingEntryPK;
import com.liferay.assetsharing.service.persistence.AssetSharingEntryPersistence;
...
public class AssetSharingEntryPersistenceImpl extends BasePersistenceImpl<AssetSharingEntry>
	...
	public AssetSharingEntry findByC_C_First(long classNameId, long classPK,
		OrderByComparator<AssetSharingEntry> orderByComparator)
		throws NoSuchAssetSharingEntryException {
		...
		throw new NoSuchAssetSharingEntryException(msg.toString());
	}
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_S_S = new FinderPath(AssetSharingEntryModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName(), Long.class.getName() },
			AssetSharingEntryModelImpl.SHAREDCLASSNAMEID_COLUMN_BITMASK |
			AssetSharingEntryModelImpl.SHAREDCLASSPK_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public List<AssetSharingEntry> findByS_S(long sharedClassNameId,
		long sharedClassPK) {
		return findByS_S(sharedClassNameId, sharedClassPK, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<AssetSharingEntry> findByS_S(long sharedClassNameId,
		long sharedClassPK, int start, int end) {
		return findByS_S(sharedClassNameId, sharedClassPK, start, end, null);
	}
	...
	public List<AssetSharingEntry> findByS_S(long sharedClassNameId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { sharedClassNameId, sharedClassPK };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_S_S;
			finderArgs = new Object[] {
					sharedClassNameId, sharedClassPK,
		...
		if ((list != null) && !list.isEmpty()) {
			for (AssetSharingEntry assetSharingEntry : list) {
				if ((sharedClassNameId != assetSharingEntry.getSharedClassNameId()) ||
						(sharedClassPK != assetSharingEntry.getSharedClassPK())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_S_S_SHAREDCLASSNAMEID_2);

			query.append(_FINDER_COLUMN_S_S_SHAREDCLASSPK_2);
			...
			try {
				...
				qPos.add(sharedClassNameId);

				qPos.add(sharedClassPK);
	 ...
	 */
	@Override
	public AssetSharingEntry findByS_S_First(long sharedClassNameId,
		long sharedClassPK,
		OrderByComparator<AssetSharingEntry> orderByComparator)
		throws NoSuchAssetSharingEntryException {
		AssetSharingEntry assetSharingEntry = fetchByS_S_First(sharedClassNameId,
		...
		msg.append("sharedClassNameId=");
		msg.append(sharedClassNameId);

		msg.append(", sharedClassPK=");
		msg.append(sharedClassPK);
	 ...
	 */
	@Override
	public AssetSharingEntry fetchByS_S_First(long sharedClassNameId,
		long sharedClassPK,
		OrderByComparator<AssetSharingEntry> orderByComparator) {
		List<AssetSharingEntry> list = findByS_S(sharedClassNameId,
				sharedClassPK, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public AssetSharingEntry findByS_S_Last(long sharedClassNameId,
		long sharedClassPK,
		OrderByComparator<AssetSharingEntry> orderByComparator)
		throws NoSuchAssetSharingEntryException {
		AssetSharingEntry assetSharingEntry = fetchByS_S_Last(sharedClassNameId,
				sharedClassPK, orderByComparator);
	 ...
	 */
	@Override
	public AssetSharingEntry fetchByS_S_Last(long sharedClassNameId,
		long sharedClassPK,
		OrderByComparator<AssetSharingEntry> orderByComparator) {
		int count = countByS_S(sharedClassNameId, sharedClassPK);
		...
		List<AssetSharingEntry> list = findByS_S(sharedClassNameId,
				sharedClassPK, count - 1, count, orderByComparator);
	...
	public AssetSharingEntry[] findByS_S_PrevAndNext(
		AssetSharingEntryPK assetSharingEntryPK, long sharedClassNameId,
		long sharedClassPK,
		OrderByComparator<AssetSharingEntry> orderByComparator)
		throws NoSuchAssetSharingEntryException {
		AssetSharingEntry assetSharingEntry = findByPrimaryKey(assetSharingEntryPK);
		...
		try {
			...
			array[0] = getByS_S_PrevAndNext(session, assetSharingEntry,
					sharedClassNameId, sharedClassPK, orderByComparator, true);

			array[1] = assetSharingEntry;

			array[2] = getByS_S_PrevAndNext(session, assetSharingEntry,
					sharedClassNameId, sharedClassPK, orderByComparator, false);
	...
	protected AssetSharingEntry getByS_S_PrevAndNext(Session session,
		AssetSharingEntry assetSharingEntry, long sharedClassNameId,
		long sharedClassPK,
		OrderByComparator<AssetSharingEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByS_S(long sharedClassNameId, long sharedClassPK) {
		for (AssetSharingEntry assetSharingEntry : findByS_S(
				sharedClassNameId, sharedClassPK, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(assetSharingEntry);
		}
	}
	...
	public int countByS_S(long sharedClassNameId, long sharedClassPK) {
		...
		Object[] finderArgs = new Object[] { sharedClassNameId, sharedClassPK };
	...
	private static final String _FINDER_COLUMN_S_S_SHAREDCLASSNAMEID_2 = "assetSharingEntry.id.sharedClassNameId = ? AND ";
	private static final String _FINDER_COLUMN_S_S_SHAREDCLASSPK_2 = "assetSharingEntry.id.sharedClassPK = ?";
	...
	public List<AssetSharingEntry> findByC_C_S(long classNameId, long classPK,
		...
		return findByC_C_S(classNameId, classPK, sharedClassNameId,
	...
	@Override
	public List<AssetSharingEntry> findByC_C_S(long classNameId, long classPK,
		long sharedClassNameId, int start, int end) {
		return findByC_C_S(classNameId, classPK, sharedClassNameId, start, end,
			null);
	}
	...
	public List<AssetSharingEntry> findByC_C_S(long classNameId, long classPK,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { classNameId, classPK, sharedClassNameId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_S;
			finderArgs = new Object[] {
					classNameId, classPK, sharedClassNameId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (AssetSharingEntry assetSharingEntry : list) {
				if ((classNameId != assetSharingEntry.getClassNameId()) ||
						(classPK != assetSharingEntry.getClassPK()) ||
						(sharedClassNameId != assetSharingEntry.getSharedClassNameId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_C_S_SHAREDCLASSNAMEID_2);
	...
	public AssetSharingEntry fetchByC_C_S_First(long classNameId, long classPK,
		...
		List<AssetSharingEntry> list = findByC_C_S(classNameId, classPK,
				sharedClassNameId, 0, 1, orderByComparator);
	...
	public AssetSharingEntry fetchByC_C_S_Last(long classNameId, long classPK,
		long sharedClassNameId,
		OrderByComparator<AssetSharingEntry> orderByComparator) {
		int count = countByC_C_S(classNameId, classPK, sharedClassNameId);
		...
		List<AssetSharingEntry> list = findByC_C_S(classNameId, classPK,
				sharedClassNameId, count - 1, count, orderByComparator);
	...
	public AssetSharingEntry[] findByC_C_S_PrevAndNext(
		AssetSharingEntryPK assetSharingEntryPK, long classNameId,
		long classPK, long sharedClassNameId,
		OrderByComparator<AssetSharingEntry> orderByComparator)
		throws NoSuchAssetSharingEntryException {
		AssetSharingEntry assetSharingEntry = findByPrimaryKey(assetSharingEntryPK);
		...
		try {
			...
			array[0] = getByC_C_S_PrevAndNext(session, assetSharingEntry,
					classNameId, classPK, sharedClassNameId, orderByComparator,
					true);
	...
	public void removeByC_C_S(long classNameId, long classPK,
		...
		for (AssetSharingEntry assetSharingEntry : findByC_C_S(classNameId,
				classPK, sharedClassNameId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(assetSharingEntry);
		}
	}
	...
	private static final String _FINDER_COLUMN_C_C_S_SHAREDCLASSNAMEID_2 = "assetSharingEntry.id.sharedClassNameId = ?";
	...
	public List<AssetSharingEntry> findByC_S_S(long classNameId,
		...
		return findByC_S_S(classNameId, sharedClassNameId, sharedClassPK,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<AssetSharingEntry> findByC_S_S(long classNameId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] {
					classNameId, sharedClassNameId, sharedClassPK
				};
		}
		else {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_S_S_SHAREDCLASSNAMEID_2);

			query.append(_FINDER_COLUMN_C_S_S_SHAREDCLASSPK_2);
	...
	public AssetSharingEntry fetchByC_S_S_First(long classNameId,
		...
		List<AssetSharingEntry> list = findByC_S_S(classNameId,
				sharedClassNameId, sharedClassPK, 0, 1, orderByComparator);
	...
	public AssetSharingEntry fetchByC_S_S_Last(long classNameId,
		long sharedClassNameId, long sharedClassPK,
		OrderByComparator<AssetSharingEntry> orderByComparator) {
		int count = countByC_S_S(classNameId, sharedClassNameId, sharedClassPK);
		...
		List<AssetSharingEntry> list = findByC_S_S(classNameId,
				sharedClassNameId, sharedClassPK, count - 1, count,
				orderByComparator);
	...
	private static final String _FINDER_COLUMN_C_S_S_SHAREDCLASSNAMEID_2 = "assetSharingEntry.id.sharedClassNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_S_S_SHAREDCLASSPK_2 = "assetSharingEntry.id.sharedClassPK = ?";
	...
	public AssetSharingEntry remove(Serializable primaryKey)
		...
		try {
			...
			if (assetSharingEntry == null) {
				...
				throw new NoSuchAssetSharingEntryException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(assetSharingEntry);
		}
		catch (NoSuchAssetSharingEntryException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public AssetSharingEntry updateImpl(
		...
		if (isNew || !AssetSharingEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((assetSharingEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						assetSharingEntryModelImpl.getOriginalSharedClassNameId(),
						assetSharingEntryModelImpl.getOriginalSharedClassPK()
					};
				...
				args = new Object[] {
						assetSharingEntryModelImpl.getSharedClassNameId(),
						assetSharingEntryModelImpl.getSharedClassPK()
					};
	...
	protected AssetSharingEntry toUnwrappedModel(
		...
		assetSharingEntryImpl.setSharedClassNameId(assetSharingEntry.getSharedClassNameId());
		assetSharingEntryImpl.setSharedClassPK(assetSharingEntry.getSharedClassPK());
