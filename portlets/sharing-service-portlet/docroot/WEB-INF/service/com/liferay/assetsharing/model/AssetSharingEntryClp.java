...
import com.liferay.assetsharing.service.ClpSerializer;
...
public class AssetSharingEntryClp extends BaseModelImpl<AssetSharingEntry>
	...
	public void setSharedClassNameId(long sharedClassNameId) {
		...
		if (_assetSharingEntryRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setSharedClassNameId",
						long.class);

				method.invoke(_assetSharingEntryRemoteModel, sharedClassNameId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSharedClassPK(long sharedClassPK) {
		...
		if (_assetSharingEntryRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setSharedClassPK", long.class);

				method.invoke(_assetSharingEntryRemoteModel, sharedClassPK);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setSharedClassNameId(getSharedClassNameId());
		clone.setSharedClassPK(getSharedClassPK());
	...
	private Class<?> _clpSerializerClass = com.liferay.assetsharing.service.ClpSerializer.class;
