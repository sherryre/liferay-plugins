...
public class AssetSharingEntryWrapper implements AssetSharingEntry,
	...
	*/
	@Override
	public com.liferay.assetsharing.service.persistence.AssetSharingEntryPK getPrimaryKey() {
	...
	/**
	* Returns the shared class name ID of this asset sharing entry.
	*
	* @return the shared class name ID of this asset sharing entry
	*/
	@Override
	public long getSharedClassNameId() {
		return _assetSharingEntry.getSharedClassNameId();
	}

	/**
	* Returns the shared class p k of this asset sharing entry.
	*
	* @return the shared class p k of this asset sharing entry
	*/
	@Override
	public long getSharedClassPK() {
		return _assetSharingEntry.getSharedClassPK();
	}
	...
	*/
	...
	public void setPrimaryKey(
		com.liferay.assetsharing.service.persistence.AssetSharingEntryPK primaryKey) {
	...
	/**
	* Sets the shared class name ID of this asset sharing entry.
	*
	* @param sharedClassNameId the shared class name ID of this asset sharing entry
	*/
	@Override
	public void setSharedClassNameId(long sharedClassNameId) {
		_assetSharingEntry.setSharedClassNameId(sharedClassNameId);
	}

	/**
	* Sets the shared class p k of this asset sharing entry.
	*
	* @param sharedClassPK the shared class p k of this asset sharing entry
	*/
	@Override
	public void setSharedClassPK(long sharedClassPK) {
		_assetSharingEntry.setSharedClassPK(sharedClassPK);
	}
